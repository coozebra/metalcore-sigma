...
export interface BaseNFTInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'removeBlacklist', values: [string[]]): string;
  ...
  decodeFunctionResult(functionFragment: 'addBlacklist', data: BytesLike): Result;
  ...
  events: {
    ...
    'LogMinted(uint256)': EventFragment;
...
export type LogBlacklistAddedEventFilter = TypedEventFilter<LogBlacklistAddedEvent>;

export type LogBlacklistRemovedEvent = TypedEvent<[string], { account: string }>;

export type LogBlacklistRemovedEventFilter = TypedEventFilter<LogBlacklistRemovedEvent>;
...
export type LogMintedEvent = TypedEvent<[BigNumber], { tokenId: BigNumber }>;
...
export interface BaseNFT extends BaseContract {
  ...
  callStatic: {
    ...
    mint(_account: string, _uri: string, overrides?: CallOverrides): Promise<void>;
    ...
    removeBlacklist(_accounts: string[], overrides?: CallOverrides): Promise<void>;
    ...
    setBaseTokenURI(_baseTokenURI: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    'LogBlacklistAdded(address)'(account?: string | null): LogBlacklistAddedEventFilter;
    LogBlacklistAdded(account?: string | null): LogBlacklistAddedEventFilter;

    'LogBlacklistRemoved(address)'(account?: string | null): LogBlacklistRemovedEventFilter;
    LogBlacklistRemoved(account?: string | null): LogBlacklistRemovedEventFilter;

    'LogBurnt(uint256)'(tokenId?: BigNumberish | null): LogBurntEventFilter;
    LogBurnt(tokenId?: BigNumberish | null): LogBurntEventFilter;

    'LogMinted(uint256)'(tokenId?: BigNumberish | null): LogMintedEventFilter;
    LogMinted(tokenId?: BigNumberish | null): LogMintedEventFilter;
