...
export interface ForeignGateInterface extends utils.Interface {
  functions: {
    "ETH_PREFIX()": FunctionFragment;
    "addOperator(address)": FunctionFragment;
    "canMint(bytes32,address,address,uint256)": FunctionFragment;
    ...
    "mint(bytes32,address,address,uint256,uint8[],bytes32[],bytes32[])": FunctionFragment;
  ...
  events: {
    ...
    "LogMint(bytes32,address,address,uint256)": EventFragment;
...
export interface ForeignGate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ForeignGateInterface;
  ...
  filters: {
    ...
    "LogMint(bytes32,address,address,uint256)"(
